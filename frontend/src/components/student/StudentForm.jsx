    ...
    >
      ...
      <div className="flex items-center" style={{ gap: '0.75rem' }}>
        <button
          type="submit"
          disabled={submitting}
          className={`bg-blue text-white font-semibold rounded-full px-5 py-2 transition-all duration-200 ${submitting ? 'opacity-60 cursor-not-allowed' : 'hover:bg-dark-blue-0 cursor-pointer'}`}
        >
        ...
        <button
          ...
          className="text-blue border border-blue rounded-full px-4 py-2 font-semibold hover:bg-blue/10 transition-colors duration-200 cursor-pointer"
        >
          Clear
        </button>
      </div>
